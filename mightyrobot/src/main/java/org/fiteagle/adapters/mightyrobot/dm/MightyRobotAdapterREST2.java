...
public class MightyRobotAdapterREST2 {
    private AbstractAdapter mightyRobotAdapterEJB;

    @PostConstruct
    public void setup() throws NamingException {
       // this.MightyRobotAdapterEJB = (IMightyRobotAdapter) new InitialContext().lookup("java:module/MightyRobotAdapter");
        this.mightyRobotAdapterEJB = MightyRobotAdapter.getInstance();
    }
    ...
    public String getDescriptionTurtle() {
        return mightyRobotAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String getDescriptionRDF() {
        return mightyRobotAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String getDescriptionNTRIPLE() {
        return mightyRobotAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String getAllInstancesTurtle() {
        return mightyRobotAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String getAllInstancesRDF() {
        return mightyRobotAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String getAllInstancesNTRIPLE() {
        return mightyRobotAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String createInstance(@PathParam("instanceNumber") int instanceNumber) {
        if (mightyRobotAdapterEJB.createInstance(instanceNumber)) {
    ...
    public String terminateInstance(@PathParam("instanceNumber") int instanceNumber) {
        if (mightyRobotAdapterEJB.terminateInstance(instanceNumber)) {
    ...
    public String monitorInstanceTurtle(@PathParam("instanceNumber") int instanceNumber) {
        return mightyRobotAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String monitorInstanceRDF(@PathParam("instanceNumber") int instanceNumber) {
        return mightyRobotAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String monitorInstanceNTRIPLE(@PathParam("instanceNumber") int instanceNumber) {
        return mightyRobotAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String controlInstanceTurtle(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return mightyRobotAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_TURTLE);
    ...
    public String controlInstanceRDF(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return mightyRobotAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_RDFXML);
    ...
    public String controlInstanceNTRIPLE(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return mightyRobotAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_NTRIPLE);
