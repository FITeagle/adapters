...
public abstract class AbstractAdapterREST {
    ...
    public void setup() throws NamingException {
       // this.abstractAdapterEJB = (IMightyRobotAdapter) new InitialContext().lookup("java:module/MightyRobotAdapter");
    ...
    public String getDescriptionTurtle() {
        return abstractAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String getDescriptionRDF() {
        return abstractAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String getDescriptionNTRIPLE() {
        return abstractAdapterEJB.getAdapterDescription(MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String getAllInstancesTurtle() {
        return abstractAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String getAllInstancesRDF() {
        return abstractAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String getAllInstancesNTRIPLE() {
        return abstractAdapterEJB.getAllInstances(MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String monitorInstanceTurtle(@PathParam("instanceNumber") int instanceNumber) {
        return abstractAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_TURTLE);
    }
    ...
    public String monitorInstanceRDF(@PathParam("instanceNumber") int instanceNumber) {
        return abstractAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_RDFXML);
    }
    ...
    public String monitorInstanceNTRIPLE(@PathParam("instanceNumber") int instanceNumber) {
        return abstractAdapterEJB.monitorInstance(instanceNumber, MightyRobotAdapter.PARAM_NTRIPLE);
    }
    ...
    public String controlInstanceTurtle(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return abstractAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_TURTLE);
    ...
    public String controlInstanceRDF(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return abstractAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_RDFXML);
    ...
    public String controlInstanceNTRIPLE(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return abstractAdapterEJB.controlInstance(inputStream, MightyRobotAdapter.PARAM_NTRIPLE);
