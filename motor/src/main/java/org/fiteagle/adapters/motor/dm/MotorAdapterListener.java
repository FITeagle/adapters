...
public class MotorAdapterListener implements IAdapterListener {
	...
	private static Logger LOGGER = Logger.getLogger(MotorAdapterListener.class
			.toString());
	...
	public void startup() throws NamingException {
		this.motorLogic = (IMotorAdapter) new InitialContext()
				.lookup("java:module/MotorAdapter");
