...
public class MotorAdapterREST {
    ...
    public String createInstance(@PathParam("instanceNumber") int instanceNumber) {
        if (motorAdapterEJB.createMotorInstance(instanceNumber)) {
    ...
    public String terminateInstance(@PathParam("instanceNumber") int instanceNumber) {
        if (motorAdapterEJB.terminateMotorInstance(instanceNumber)) {
    ...
    public String monitorInstanceTurtle(@PathParam("instanceNumber") int instanceNumber) {
        return motorAdapterEJB.monitorMotorInstance(instanceNumber, MotorAdapter.PARAM_TURTLE);
    }
    ...
    public String monitorInstanceRDF(@PathParam("instanceNumber") int instanceNumber) {
        return motorAdapterEJB.monitorMotorInstance(instanceNumber, MotorAdapter.PARAM_RDFXML);
    }
    ...
    public String monitorInstanceNTRIPLE(@PathParam("instanceNumber") int instanceNumber) {
        return motorAdapterEJB.monitorMotorInstance(instanceNumber, MotorAdapter.PARAM_NTRIPLE);
    }
    ...
    public String controlInstanceTurtle(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return motorAdapterEJB.controlMotorInstance(inputStream, MotorAdapter.PARAM_TURTLE);
    ...
    public String controlInstanceRDF(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return motorAdapterEJB.controlMotorInstance(inputStream, MotorAdapter.PARAM_RDFXML);
    ...
    public String controlInstanceNTRIPLE(MultipartFormDataInput input) {
        ...
        for (InputPart inputPart : inputParts) {
            ...
            try {
                ...
                return motorAdapterEJB.controlMotorInstance(inputStream, MotorAdapter.PARAM_NTRIPLE);
