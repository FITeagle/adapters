...
omlInst.addmp("availability", "hostname:string:{omn:Resource|omn-resource:hasName|%value%} availability:int32:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:Availability}{MOFID:Availability|MOFID:hasMetricAttributes|MOFID:AvailabilityMeasurement}{MOFID:AvailabilityMeasurement|MOFID:MeasurementDataValue|%value%} timestamp:datetime:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:Availability}{MOFID:Availability|MOFID:hasMetricAttributes|MOFID:AvailabilityMeasurement}{MOFID:AvailabilityMeasurement|MOFID:timestamp|%value%} ")
omlInst.addmp("total_memory", "hostname:string:{omn:Resource|omn-resource:hasName|%value%} total_memory:double:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:TotalMemory}{MOFID:TotalMemory|MOFID:hasMetricAttributes|MOFID:TotalMemoryMeasurement}{MOFID:TotalMemoryMeasurement|MOFID:MeasurementDataValue|%value%}{MOFID:TotalMemoryMeasurement|MOFID:isMeasuredIn|MOFIU:Byte}{MOFID:TotalMemoryMeasurement|MOFIU:hasPrefix|MOFIU:giga} timestamp:datetime:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:TotalMemory}{MOFID:TotalMemory|MOFID:hasMetricAttributes|MOFID:TotalMemoryMeasurement}{MOFID:TotalMemoryMeasurement|MOFID:timestamp|%value%} ")
omlInst.addmp("available_memory", "hostname:string:{omn:Resource|omn-resource:hasName|%value%} available_memory:double:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:AvailableMemory}{MOFID:AvailableMemory|MOFID:hasMetricAttributes|MOFID:AvailableMemoryMeasurement}{MOFID:AvailableMemoryMeasurement|MOFID:MeasurementDataValue|%value%}{MOFID:AvailableMemoryMeasurement|MOFID:isMeasuredIn|MOFIU:Byte}{MOFID:AvailableMemoryMeasurement|MOFIU:hasPrefix|MOFIU:giga} timestamp:datetime:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:AvailableMemory}{MOFID:AvailableMemory|MOFID:hasMetricAttributes|MOFID:AvailableMemoryMeasurement}{MOFID:AvailableMemoryMeasurement|MOFID:timestamp|%value%} ")
omlInst.addmp("used_memory", "hostname:string:{omn:Resource|omn-resource:hasName|%value%} used_memory:double:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:UsedMemory}{MOFID:UsedMemory|MOFID:hasMetricAttributes|MOFID:UsedMemoryMeasurement}{MOFID:UsedMemoryMeasurement|MOFID:MeasurementDataValue|%value%}{MOFID:UsedMemoryMeasurement|MOFID:isMeasuredIn|MOFIU:Byte}{MOFID:UsedMemoryMeasurement|MOFIU:hasPrefix|MOFIU:giga} timestamp:datetime:{omn:Resource|MOFID:hasMeasurementMetric|MOFID:UsedMemory}{MOFID:UsedMemory|MOFID:hasMetricAttributes|MOFID:UsedMemoryMeasurement}{MOFID:UsedMemoryMeasurement|MOFID:timestamp|%value%} ")
#-----------------------------------------------------------------------#
omlInst.start()
