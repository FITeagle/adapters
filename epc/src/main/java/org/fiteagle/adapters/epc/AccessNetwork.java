...
public class AccessNetwork {
	...
	private static final Logger LOGGER = Logger.getLogger(AccessNetwork.class.toString());

	public AccessNetwork(final EpcAdapter owningAdapter, final String instanceName) {
